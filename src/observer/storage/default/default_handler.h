...
public:
   ...
   * @return
   */
  RC create_index(Trx *trx, const char *dbname, const char *relation_name, const char *index_name, const char *attribute_name, int is_unique);

  RC create_multi_index(Trx *trx, const char *dbname, const char *relation_name, const char *index_name, const RelAttr *attr_list, int attr_num, int is_unique);
   ...
   * @return
   */
  RC insert_record(Trx * trx, const char *dbname, const char *relation_name, int value_num, const Value *values, int record_num, const int record_pos[]);
